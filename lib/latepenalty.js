...
export default function credit(t) {
  ...
  else if (t < 60) { return hscale(300000, t, 0, 60, 1, 0.99999) } else if (t < SIH) { return hscale(3000, t, 60, SIH, 0.99999, 0.999) } else if (t < SID) { return hscale(548, t, SIH, SID, 0.999, 0.99) } else if (t < SIW) { return hscale(32, t, SID, SIW, 0.99, 0.9) } else if (t < SIM) { return hscale(5.4, t, SIW, SIM, 0.9, 0.5) } else if (t < SIY) { return hscale(4.2, t, SIM, SIY, 0.5, 0.1) }
  return hscale(4, t, SIY, 10 * SIY, 0.1, 0.01)
}
