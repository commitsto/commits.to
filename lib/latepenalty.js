...
const SIM = 30*SIM     // seconds in a month ( deadlines are the same time of )
...
export default function credit(t) {
  ...
  else if (t < SIW)  { return hscale(hDays, t, SID,  SIW,    cHrs,  cDays) }
  else if (t < SIM)  { return hscale(hWks,  t, SIW,  SIM,    cDays, cWks)  }
  else if (t < SIY)  { return hscale(hMos,  t, SIM,  SIY,    cWks,  cMos)  }
  else               { return hscale(hYrs,  t, SIY,  10*SIY, cMos,  cYrs)  }
}
